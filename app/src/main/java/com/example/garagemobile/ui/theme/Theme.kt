...
package com.example.garagemobile.ui.theme
...
private val LightColorPalette = GarageMobileColors(
    brand = Shadow5,
...
private val DarkColorPalette = GarageMobileColors(
    brand = Shadow1,
...
@Composable
fun GarageMobileTheme(
    darkTheme: Boolean = isSystemInDarkTheme(),
    content: @Composable () -> Unit
) {
    val colors = if (darkTheme) DarkColorPalette else LightColorPalette

    ProvideGarageMobileColors(colors) {
        MaterialTheme(
...
object GarageMobileTheme {
    val colors: GarageMobileColors
        @Composable
        get() = LocalGarageMobileColors.current
}
...
class GarageMobileColors(
    ...
    fun update(other: GarageMobileColors) {
    ...
    fun copy(): GarageMobileColors = GarageMobileColors(
...
@Composable
fun ProvideGarageMobileColors(
    colors: GarageMobileColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalGarageMobileColors provides colorPalette, content = content)
}

private val LocalGarageMobileColors = staticCompositionLocalOf<GarageMobileColors> {
    error("No JetsnackColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [GarageMobileColors.colors].
 */
fun debugColors(
    darkTheme: Boolean,
